...
with open('E:/webDevelopment/HTML_projects/HealthScope/static/prediction-models/diabetes_scaler.pkl', 'rb') as scaler_file:
    diabetes_scaler = pickle.load(scaler_file)

with open('E:/webDevelopment/HTML_projects/HealthScope/static/prediction-models/diabetes_model.pkl', 'rb') as model_file:
    diabetes_classifier = pickle.load(model_file)

with open('E:/webDevelopment/HTML_projects/HealthScope/static/prediction-models/breast_cancer_model.pkl', 'rb') as model_file:
    breast_cancer_model = pickle.load(model_file)

with open('E:/webDevelopment/HTML_projects/HealthScope/static/prediction-models/heart_disease_model.pkl', 'rb') as model_file:
    heart_disease_model = pickle.load(model_file)

with open('E:/webDevelopment/HTML_projects/HealthScope/static/prediction-models/parkinsons_scaler.pkl', 'rb') as scaler_file:
    parkinsons_scaler = pickle.load(scaler_file)

with open('E:/webDevelopment/HTML_projects/HealthScope/static/prediction-models/parkinsons_model.pkl', 'rb') as model_file:
...
if __name__ == '__main__':
    ...
    if not app.debug or 'WERKZEUG_RUN_MAIN' in os.environ:
